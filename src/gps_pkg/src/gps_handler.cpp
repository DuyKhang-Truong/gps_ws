...
{
    while ((analysis_param.pos = raw_data.find(delimiter)) != string::npos) {
        analysis_param.cnt++;
        if(analysis_param.cnt == 2){
